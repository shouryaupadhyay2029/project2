...
const createProject = async(req, res) => {
    try {
        const { title, description, techStack, githubUrl, liveUrl, status, thumbnail } = req.body;
        ...
        await createActivity(
            ...
            `Project "${title}" was created`, { projectId: project._id, projectTitle: title },
            'public'
        );
...
const updateProject = async(req, res) => {
    try {
        ...
        await createActivity(
            ...
            'project_updated',
            'Updated a project',
            `Project "${updatedProject.title}" was updated`, { projectId: updatedProject._id, projectTitle: updatedProject.title },
            'public'
        );
...
const deleteProject = async(req, res) => {
    try {
        ...
        await createActivity(
            ...
            'project_deleted',
            'Deleted a project',
            `Project "${project.title}" was deleted`, { projectId: project._id, projectTitle: project.title },
            'private'
        );
...
const featureProject = async(req, res) => {
    try {
        ...
        if (!project.featured) {
            await Project.updateMany({ owner: req.user.id, featured: true }, { featured: false });
        }
        ...
        await createActivity(
            ...
            `Project "${project.title}" was ${project.featured ? 'featured' : 'unfeatured'}`, { projectId: project._id, projectTitle: project.title, featured: project.featured },
            'public'
        );
